...
def start_pannel():  
    buttons = [
            [ 
                InlineKeyboardButton(text="قناة البوت", url="https://t.me/Y88F8"),
                InlineKeyboardButton(text="المطور", url="https://t.me/ZDDDU")
            ],
    ]
    return "✧ اهلًا بك في ريمي ميوزك .\n𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝑹𝒆𝒎𝒚 𝑴𝒖𝒔𝒊𝒄", buttons
...
pstart_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "اضف البوت الى مجموعتك", url="https://t.me/JelthonMusicBot?startgroup=true")
                ],[
                    InlineKeyboardButton(
                        "قناة البوت", url="https://t.me/JelthonMusicBot"),
                    InlineKeyboardButton(
                        "قناة المطور", url="https://t.me/Y88F8")
                ],[
                    InlineKeyboardButton(
                        "مطور البوت", url="https://t.me/ZDDDU")
                ],
            ]
        )
            ...
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        url=f'https://t.me/JelthonMusicBot?startgroup=true'),
                        ],
                    ]
                )
            )
...
async def start(_, message: Message):
    ...
    out = start_pannel()
    await message.reply_text(f"✶ مرحبا {message.from_user.mention}!\n\n✶ قم بترقيتي مشرف لتتمكن من الاستمتاع بخدمتي.", reply_markup=InlineKeyboardMarkup(out[1]))
    return
...
async def play(_, message: Message):
    if len(message.command) == 1:
        ...
        await app.send_message(message.chat.id,
            text=f"**✧ اهلًا بك في ريمي ميوزك .**\n𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝑹𝒆𝒎𝒚 𝑴𝒖𝒔𝒊𝒄\n    \n✶ **انا بوت استطيع تشغيل الموسيقي والفيديو في محادثتك الصوتية**\n\n**✶ لعرض الأوامر وباقي التفاصيل ارسل [ /panel ] .",
            parse_mode="markdown",
        ...
        finxx = (f"{f1}{f2}{f3}")
        if str(finxx) == "inf":
            boom = await app.send_message(chat_id, "✶ جار جلب المعلومات...")
...
@Client.on_message(
    command(["help", f"commands"]) & filters.group & ~filters.edited
)
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    "اوامر المشرفين", callback_data="cbadmin"
                ),
            ],
            [
                InlineKeyboardButton("قناة البوت", url=f"https://t.me/Y88F8"),
            ]
        ]
    )
    ...
    await message.reply_photo(
        photo=f"https://telegra.ph/file/c621a0bd3897c2b10a8a6.jpg",
        caption=alive,
        reply_markup=keyboard,
    )


@Client.on_message(filters.command("اوامر", [".", ""]) & filters.group & ~filters.edited)
async def jelthon(client: Client, message: Message):
...
async def aboutdev(client: Client, message: Message):
    usr = await client.get_chat(5117901887)
    name = usr.first_name
    bio = (await client.get_chat(5117901887)).bio
    async for photo in client.iter_profile_photos(5117901887, limit=1):
                    await message.reply_photo(photo.file_id, caption=f"""{bio}""", 
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        name, url=f"https://t.me/ZDDDU")
                ],
            ]
        ),
    ) 
...
@Client.on_message(filters.regex("^سورس$") & filters.group & ~filters.edited)
async def source(client: Client, message: Message):
    buttons = [[InlineKeyboardButton("✯", url="t.me/Y88F8")]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_text(
        f"""✯ 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐞𝐦𝐲 𝐛𝐫𝐨\n𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 → [𝐙𝐚𝐢𝐝](https://t.me/ZDDDU)\n𝐂𝐡𝐚𝐧𝐧𝐞𝐥 → [- 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒆𝒎𝒚](https://t.me/Y88F8)""", 
        disable_web_page_preview=True,
        reply_markup=reply_markup,
    )     
    
@Client.on_message(filters.regex("^السورس$"))
async def sourceThe(client: Client, message: Message):
    buttons = [[InlineKeyboardButton("✯", url="t.me/Y88F8")]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_text(
        f"""✯ 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐞𝐦𝐲 𝐛𝐫𝐨\n𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 → [𝐙𝐚𝐢𝐝](https://t.me/ZDDDU)\n𝐂𝐡𝐚𝐧𝐧𝐞𝐥 → [- 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒆𝒎𝒚](https://t.me/Y88F8)""", 
...
@Client.on_message(filters.regex("^ايدي القروب$") & filters.group & ~filters.edited)
async def idgroup(client: Client, message: Message):
    usr = await client.get_users(message.from_user.id)
    name = usr.first_name
    usrn = message.from_user.username
    buttons = [[InlineKeyboardButton(name, url="t.me/Y88F8")]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_text(
...
@Client.on_message(filters.regex("^رابط الحذف$") & filters.group & ~filters.edited)
async def detlk(client: Client, message: Message):
        await message.reply_text(
        f"""✶ اليك روابط حذف حسابات مواقع التواصل الاجتماعي""",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                    ...
                    [  
                        InlineKeyboardButton("سناب شات", url=f"https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"),
                        InlineKeyboardButton("انستاجرام", url=f"https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/")
                    ],
                    [
                        InlineKeyboardButton(
                            " فيسبوك", url=f"https://www.faecbook.com/help/deleteaccount"
                        ),
                        InlineKeyboardButton(
                            "تويتر", url=f"https://mobile.twitter.com/settings/deactivate"
                        ),
                    ],
                ]
            ),
...
@Client.on_message(filters.command("mention", [".", ""]) & filters.group & ~filters.edited)
async def devsf(client: Client, message: Message):
    uid = int(message.text.strip().split()[1])
    buttons = [[InlineKeyboardButton("Zaid", url="t.me/ZDDDU")]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_text(
        f"""[𝐇𝐞𝐫𝐞](tg://user?id={uid})""", 
        reply_markup=reply_markup,
    )   
  

REPLY_MESSAGE = "- اختر من الازرار ادناه"
...
@Client.on_message(filters.private & filters.incoming & filters.command("panel"))
...
@Client.on_message(filters.command("الاوامر", [".", ""]) & filters.private & ~filters.edited)
async def jelthonpri(client: Client, message: Message):
...
@Client.on_message(filters.command("افتارات شباب", [".", ""]) & filters.group)
async def avtarA(c,m):
...
@Client.on_message(filters.command("غنيلي", [".", ""]) & ~filters.edited)
async def avtarMusic(c,m):
    rl = random.randint(3,534)
    url = f"https://t.me/PythonDeploy/{rl}"
    await m.reply_voice(url, caption="༄ @Y88F8",parse_mode="html",reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " - 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒆𝒎𝒚", url=f"https://t.me/Y88F8")
                ],
            ]
        ),
    ) 
...
@Client.on_message(filters.command("افتارات انمي", [".", ""]) & filters.group)
async def avtarA(c,m):
...
@Client.on_message(filters.command("افتار", [".", ""]) & ~filters.edited) 
async def theav(client: Client, message: Message):
...
@Client.on_message(filters.command("طريقة التفعيل", [".", ""]) & filters.private & ~filters.edited) 
async def howtouse(client: Client, message: Message):
    buttons = [[InlineKeyboardButton("✯", url="t.me/Y88F8")]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_text(
        f"""✯ 1 - قم باضافة البوت الى مجموعتك ورفعه مشرف بكافة الصلاحيات\n✯ 2 - اضف الحساب المساعد [ @JelthonAssistant ] او اكتب تشغيل سينضم تلقائيًا\n✯ 3 - اضغط على زر الاوامر لمعرفة باقي الاوامر\n\n✯ 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 → [- 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒆𝒎𝒚](https://t.me/Y88F8)""", 
        disable_web_page_preview=True,
        reply_markup=reply_markup,
    )   
          

REP = "- اختر من الازرار ادناه"
...
@Client.on_message(filters.regex("^- قسم المميزات ✨$") & filters.private)
async def cpanel2(_, message: Message):             
        text = REP
        reply_markup = ReplyKeyboardMarkup(REPB, resize_keyboard=True)
        await message.reply(
              text=text,
              reply_markup=reply_markup
        )    
...
REPLY_MESSAGE2 = "- اختر من الازرار ادناه"

REPLY_MESSAGE_BUTTONS2 = [
          [
             ("- قسم المميزات ✨")
          ],
          [
...
@Client.on_message(filters.regex("^القائمة الرئيسية$") & filters.private)
async def cpane3l(_, message: Message):             
        text = REPLY_MESSAGE2
        reply_markup = ReplyKeyboardMarkup(REPLY_MESSAGE_BUTTONS2, resize_keyboard=True)
        await message.reply(
              text=text,
              reply_markup=reply_markup
        )     
...
@Client.on_message(filters.regex("^- 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒆𝒎𝒚$") & filters.private)
...
@Client.on_message(filters.regex("^- قسم الأفلام .$") & filters.private)
async def cpane3l2(_, message: Message):             
        text = REP3
        reply_markup = ReplyKeyboardMarkup(REPB3, resize_keyboard=True)
        await message.reply(
              text=text,
              reply_markup=reply_markup
        )     

REPX = "- اختر من الازرار ادناه"
...
@Client.on_message(filters.regex("^رجوع$") & filters.private)
async def cpa56nel2(_, message: Message):             
        text = REPX
        reply_markup = ReplyKeyboardMarkup(REPVC, resize_keyboard=True)
        await message.reply(
              text=text,
              reply_markup=reply_markup
        )    
