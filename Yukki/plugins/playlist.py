...
@Client.on_message(filters.command("قائمة التشغيل", [".", ""]) & ~filters.edited)
async def start_playlist_cmd(_, message):
    thumb ="https://telegra.ph/file/e325c63f6cb307ac65eda.jpg"
    await message.reply_photo(
    photo=thumb, 
    caption=("**اي قائمة تشغيل تريد ان اشغلها**"),    
